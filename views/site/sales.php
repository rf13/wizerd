...
<div class="how-it-works-wrapper">    
  ...
  <div class="tellus-servofferings padding-wrapper clearfix">  
    ...
    <div class="col-md-6 col-sm-6">
      ...
      <p>Create a menu for all the services your business offers. It's fully customizable to your business needs. The process is crfazy simple and takes less than 10 minutes to complete.</p>
    </div>
  ...
  <div class="tellus-relax padding-wrapper clearfix">  
...
<div class="container-fluid how-it-works-business-panel consumer-wrapper">
  <div class="container">
    <div class="row">
      <div class="col-md-12">
        <h2>CONSUMER</h2>
    ...
    <div class="row">
      ...
      <div class="tellus-relax padding-wrapper clearfix">
        ...
        <div class="col-md-6">
          ...
          <p>Contact the business that meets your needs. Give yourself a part on the back for all the time and money you just saved...and knowing you're getting a great service at a fair price.</p>
        </div>
...
<div class="container-fluid how-it-works-business-panel signup-wrapper">
  <div class="container">
    ...
    <h4>Use of search engine does not require an account.<br>  Consumer only needs an account to save promotions.<br> Business must have an account.  <br>
